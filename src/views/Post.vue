<template>
    <MasterLayout :title="title">
        <div class="posts_container content_width">
            <h3 class="section_col_header text-center">{{ postTitle }}</h3>
